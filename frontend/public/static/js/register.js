                ...
                <div class="modal-content bg-dark text-white">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-control bg-dark text-white __data" style="overflow-y: auto;">
                            ...
                            <ul class="mt-4">
                                <li>
                                    Canal: <a href="https://wa.link/1oj2xx" class="text-reset">DTunnel</a>
                                </li>
                                <li>
                                    Grupo: <a href="https://wa.link/1oj2xxGroup" class="text-reset">DTunnelGroup</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content bg-dark text-white">
                    ...
                    <div class="modal-body">
                        ...
                        <ul>
                            <li>
                                Canal: <a href="https://wa.link/1oj2xx" class="text-reset">DTunnelMod</a>
                            </li>
                            <li>
                                Grupo: <a href="https://wa.link/1oj2xxGroup" class="text-reset">DTunnelModGroup</a>
                            </li>
                        </ul>
                    </div>
                </div>
